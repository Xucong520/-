# -*- coding: utf-8 -*-
"""
Created on Thu Oct 24 16:23:01 2019
...
def getEmail():
    ...
    username=''.join((choise(characters)for i in range(randint(6,12))))
    domain=''.join((choise(characters)for i in range(randint(3,6))))
    return username+'@'+domain+choise(suffix)
def getTelNo():
